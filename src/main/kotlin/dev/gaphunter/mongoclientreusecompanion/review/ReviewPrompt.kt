package dev.gaphunter.mongoclientreusecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.mongoclientreusecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.mongoclientreusecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "MongoDB Client Reuse Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33877-mongodb-client-reuse-companion/reviews"
